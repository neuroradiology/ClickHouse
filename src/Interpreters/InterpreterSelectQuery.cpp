    ...
    , prepared_sets(prepared_sets_)
{
    ...
    if (storage && settings.use_parallel_replicas > 0 && context->getParallelReplicasMode() == ParallelReplicasMode::CUSTOM_KEY_SAMPLING && !joined_tables.tablesWithColumns().empty())
    {
